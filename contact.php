                ...
                <div class="A1" id="container">
                    ...
                    <div class="logs1">
                        <form method="post">
                            ...
                            <div>
                            <textarea class="z1" type="text" placeholder="Input Message" name="utext" style="width: 100%; height: 80px;" required></textarea>
                            </div>
                            <div class="g-recaptcha" data-sitekey="6LdtTU0qAAAAAGgIqe3GbOdonrOqhBNOa-6Y-YQ2"></div>
                            <div>
                                <button class="Li" type="submit" value="login" name="submit">Submit</button>
                               
                            </div>
                            
                            <div id="Line">
                            </div>
                            <button class="CA" type="submit"><a href="login.php" style="color: #ffffff; text-decoration: none;">go to Login Page</a></button>
